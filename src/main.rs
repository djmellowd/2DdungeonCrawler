...
use prelude::*;
use crate::VirtualKeyCode::Comma;
...
impl State
{
    fn new() -> Self
    {
        ...
        resources.insert(map_builder.player_start);
    ...
    fn game_over(&mut self, ctx: &mut BTerm)
    {
        ...
        ctx.print_color_centered(4, WHITE, BLACK, "Slained by a monster, your hero's journey has come to a premature end.");
